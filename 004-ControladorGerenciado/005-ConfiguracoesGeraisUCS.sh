...
################################################################
####														####
####     		CONFIGURAÇOES GERAIS DO SERVIDOR UCS   		####
####														####
################################################################
################################################################
...
01. Acessar o WebManagement (recomendado utilizar o navegado Firefox)
		https://10.147.18.3				Zerotier
		https://173.169.73.3			LAN
				...
				UCS-DC-01
					Basic settings
						Computer account
							...
							Description: Servidor de Nó Gerenciado
